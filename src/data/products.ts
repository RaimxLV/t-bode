...
export const products: Product[] = [
  // ── T-SHIRTS ──────────────────────────────────────────
  {
    ...
    colors: [
      ...
      { name: "Red", hex: "#dd4444" },
      { name: "Aloe", hex: "#abc1a4" },
      { name: "Anthracite", hex: "#474747" },
      { name: "Aqua blue", hex: "#22b8d6" },
      { name: "Burgundy", hex: "#560000" },
      { name: "Cotton pink", hex: "#ffcece" },
      { name: "French navy", hex: "#002a3f" },
      { name: "Heather gray", hex: "#a0a0a0" },
      { name: "India ink gray", hex: "#3d3d3d" },
      { name: "Mid heather gray", hex: "#969696" },
      { name: "Natural raw", hex: "#e2ded3" },
      { name: "Vintage", hex: "#ededde" },
    ],
    sizes: ["S", "M", "L", "XL", "XXL"],
  },
  {
