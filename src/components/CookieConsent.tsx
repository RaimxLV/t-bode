            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-3">
                  <button
                    onClick={accept}
                    className="px-6 py-2 rounded-lg text-sm font-semibold font-body text-white transition-all hover:scale-105 bg-cta-red"
                  >
                    {t("cookies.accept", "Pieņemt visas")}
                  </button>
                  <button
                    onClick={decline}
                    className="px-6 py-2 rounded-lg text-sm font-semibold font-body border border-border text-foreground hover:bg-muted transition-all"
                  >
