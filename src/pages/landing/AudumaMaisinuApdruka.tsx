...
const AudumaMaisinuApdruka = () => (
  <SeoLandingPage
    ...
    intro={[
      ...
      "Populārākie pielietojumi: korporatīvās dāvanas klientiem un darbiniekiem, konferenču un semināru maisiņi, sporta komandu apdruka, bērnudārza grupiņu identifikācija, kāzu dāvaniņas viesiem un, protams, ikdienas iepirkšanās maisiņš ar paša izvēlētu dizainu.",
      "Apdrukājam Rīgā 2–5 darba dienās. Bez minimālā pasūtījuma — gan viens maisiņš, gan liels korporatīvs pasūtījums.",
    ]}
  />
);
