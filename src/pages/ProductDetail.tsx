      ...
      <Seo
        ...
        description={(() => {
          ...
          const suffix = i18n.language === "en"
            ? ` — customize on-site in Riga. T-Bode printing on t-shirts, hoodies, mugs and bags.`
            : ` — personalizē ar savu dizainu. T-Bode apdruka Rīgā uz krekliem, hūdijiem, krūzēm un somām.`;
