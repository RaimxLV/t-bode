    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          <a href="/"><img src={logo} alt="T-Bode" className="h-12 mx-auto mb-4" /></a>
          <h1 className="text-2xl font-display">{isLogin ? t("auth.login") : t("auth.register")}</h1>
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          <Button variant="outline" className="w-full mb-4 font-body" onClick={handleGoogleLogin} disabled={loading}>
